          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenuModal">Add New Karyawan</a>
               <a target="_blank" href="<?php echo base_url('karyawan/print')?>" class="btn btn-success mb-3">
                    ...
                    <?php foreach ($karyawan as $m) : ?>
                        <tr>
                            ...
                            <td style="text-align: center">
                               <a class="badge badge-success" href="<?=site_url('admin/overview/'.$m['kode'])?>">
            ...
            <form action="<?= base_url('karyawan/add'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ttl" name="ttl" placeholder="Tempat Lahir" required="" autocomplete="off"><br>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <option value="">--Edit Divisi--</option>
                <?php foreach ($divisi as $c => $d) {
                  echo '<option value="'.$d->id.'">'.$d->divisi.'</option>';
                } ?>                
                </select><br>
...
$(document).on('click', '#edit-proses', function()
    {
      ...
      if (nama == '') {
        ...
        data: {'edit' : true,'nama':nama,'email': email,'kode':kode,'divisi':divisi,'jabatan':jabatan,'ttl' : ttl,'telp': telp,'alamat':alamat,'nik':nik}, 
        dataType : 'json',
        success: function(result) {
          if (result.success == true) {
            alert('Karyawan Berhasil di Update')
            $('#modal-item-update').modal('hide');
            location.reload('<?=site_url('karyawan') ?>');
          } else { 
            alert('Gagal')}
           } 
        })
