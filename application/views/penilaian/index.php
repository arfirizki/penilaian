...
<div class="row">
            ...
            <div class="col-lg-5">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-group row">
                    <label for="name" class="col-sm-4 col-form-label">Divisi </label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="divisi" name="divisi" value="" readonly="">
                    </div>
                </div>    
...
<script>
 function handleChange(input) {
    if (input.value < 0) alert('nilai Tidak boleh negatif');
    if (input.value <= 0) alert('nilai Tidak NOL');
