            ...
            <div class="col-lg-12">
              ...
              <div>
                <div class="card-header py-8 no-print">
                    <a href="<?=base_url('kepaladivisi/pegawai')?>" class="btn btn-waring btn-flat">
                      <i class="fa fa-undo"></i> Back
                    </a> 
                    <form action="<?=base_url('kepaladivisi/overviewdetail')?>" method="POST">
                ...
                <br>
                <br>
                <h2>OverView Penilaian Kinerja Pegawai <?=$pegawai->nama?> Perbulan dari Total Nilai </h2>
                <!-- <div id="graph"></div> -->
                <div class="card-body">
